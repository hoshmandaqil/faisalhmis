<form action="{{route('patient_pharmacy_medicine.update', $patient_id)}}" method="post">
    @csrf
    ...
    <div class="submit-section">
        ...
        <button class="btn btn-danger submit-btn btn-sm" type="submit">Save changes</button>
    </div>
</form>
