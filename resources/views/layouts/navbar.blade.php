        ...
        <ul class="navbar-nav m-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('my_patients') }}">My Patients</a>
                        </li>
                        @if (in_array('doctor_sale_medicine', $user_permissions))
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('my_patients_medicines') }}">My Patients
                                    (Pharmacy)</a>
                            </li>
                        @endif
                        @if (in_array('doctor_sale_ipd', $user_permissions))
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('my_patients_lab_ipd') }}">My Patients (Lab &
                                    IPD)</a>
                            </li>
                        @endif
                    </ul>
            ...
            @if (in_array('pharmacy_menu', $user_permissions))
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('patient_pharmacy_medicine.index') }}">Sale
                                Medicine</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('pharmacy.index') }}">Procurement</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            @if (in_array('reception_menu', $user_permissions))
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('patient.index') }}">Patient Registration</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                                href="{{ url('patient_reception_medicine') }}">Pharmacy
                                Patients</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                                href="{{ url('reception_patient_labs') }}">Laboratory Patients</a>
                        </li>
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('patient_ipd.index') }}">IPD Patients</a>
                        </li>
                    </ul>
                </li>
            @endif
            ...
            @if (in_array('lab_menu', $user_permissions))
                ...
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        <li>
                            <a class="dropdown-item"
                                href="{{ route('patient_lab.index') }}">Laboratory Patients</a>
                        </li>
                        @if (in_array('delete_lab', $user_permissions))
                            <li>
                                <a class="dropdown-item"
                                    href="{{ url('recent_entries_lab_patients') }}">Recent Tests
                                    (Duplicate) </a>
                            </li>
                        @endif
                    </ul>
            ...
            <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu dropdown-menu-right"
                    ...
                    <li>
                        <a class="dropdown-item"
                            href="{{ route('employee.index') }}">Employees Management</a>
                    </li>
                </ul>
            </li>
            ...
            @if (in_array('reports_view', $user_permissions))
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        aria-labelledby="appsDropdown">
                        <li>
                            <a class="dropdown-toggle sub-nav-link"
                                id="submenuDropdown"
                                data-toggle="dropdown"
                                href="#"
                                role="button"
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"
                                ...
                                @if (in_array('datewise_sale_report', $user_permissions))
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ url('date_wise_sale_report') }}">Pharmacy
                                            Sale
                                            Report</a>
                                    </li>
                                @endif
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('laboratory_sale_report') }}">Diagnosis
                                        Report</a>
                                </li>

                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('ipd_patient_report') }}">
                                        IPD Patients Report
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('registered_patient_report') }}">
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('employee_percentage_report') }}">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"
                                ...
                                @if (in_array('available_stock_report', $user_permissions))
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ url('available_stock_report') }}">Available
                                            Stock Report</a>
                                    </li>
                                @endif
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('returned_medicines_report') }}">Returned
                                        Medicines Report</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"
                                ...
                                @if (in_array('short_pharmacy_report', $user_permissions))
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ url('short_pharmacy_report') }}">Short
                                            Pharmacy
                                            Report</a>
                                    </li>
                                @endif
                                ...
                                @if (in_array('expired_medicine_report', $user_permissions))
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ url('expired_medicine_report') }}">Expired
                                            Medicine Report</a>
                                    </li>
                                @endif
                                ...
                                @if (in_array('medication_report', $user_permissions))
                                    <li>
                                        <a class="dropdown-item"
                                            href="{{ url('medication_report') }}">Medication
                                            Report</a>
                                    </li>
                                @endif
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('laboratory_tests_report') }}">Laboratory
                                        Tests
                                        Report
                                    </a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('general_profits_report') }}">
                                        General Report
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('new_general_profits_report') }}">
                                        Optimized General Report
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ url('cumulative_report') }}">
                                        Cumulative Report
                                    </a>
                                </li>
                            </ul>
                ...
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        @if (in_array('floor_list', $user_permissions))
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('floor.index') }}">Floors</a>
                            </li>
                        @endif
                        @if (in_array('lab_list', $user_permissions))
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('lab_department.index') }}">Lab
                                    Departments</a>
                            </li>
                        @endif
