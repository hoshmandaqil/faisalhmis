...
@include('layouts.page_header_print', ['reportName' => 'Registered Patients Report', 'from' => $from, 'to' => $to])
@endsection
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Date Wise IPD Report</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{url('registered_patient_report')}}" method="GET" enctype="multipart/form-data" id="medicineForm">
